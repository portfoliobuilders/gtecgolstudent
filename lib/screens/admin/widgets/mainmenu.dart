...
//               onTap: () => updateSelectedMenu('Course'),
//             ),
//                 AdminSidebarButton(
//               icon: Icons.live_tv,
...
//               onTap: () => updateSelectedMenu('Students'),
//             ),
//             AdminSidebarButton(
//               icon: Icons.person,
//               text: 'Batch Management',
//               isSelected: selectedMenu == 'Batch',
//               onTap: () => updateSelectedMenu('Batch'),
//             ),
//              AdminSidebarButton(
//             icon: Icons.settings,
//             text: 'User Management',
//             isSelected: selectedMenu == 'User',
//             onTap: () => updateSelectedMenu('User'),
//           ),
